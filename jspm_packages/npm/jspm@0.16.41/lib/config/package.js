...
(function(process) {
  ...
  PackageJSON.prototype.read = function(prompts, sync) {
    ...
    if (prompts) {
      ...
      return doInitPrompts(pjson, self.fileName, self.jspmPrefix).then(function(prefixed) {
    ...
    function setDefaults() {
      ...
      self.packages = pjson.directories && pjson.directories.packages && path.resolve(self.dir, pjson.directories.packages) || pjson.directories && pjson.directories.jspmPackages && path.resolve(self.dir, pjson.directories.jspmPackages) || defaults.packages;
