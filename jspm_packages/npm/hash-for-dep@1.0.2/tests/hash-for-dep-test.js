...
describe('hashForDep', function() {
  it('Provides a consistent md5 hash for a dependent package', function() {
    ...
    var hashTreePaths = [path.join(fixturesPath, '/node_modules/dedupped/'), path.join(fixturesPath, '/node_modules/dedupped/node_modules/dedupped-child/'), path.join(fixturesPath, '/node_modules/foo/')];
