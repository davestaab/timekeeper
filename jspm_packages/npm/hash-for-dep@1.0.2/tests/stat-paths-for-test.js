...
describe('statPathsFor', function() {
  it('Should return stat paths for a module', function() {
    var expectedStatPaths = [path.join(fixturesPath, '/node_modules/dedupped/'), path.join(fixturesPath, '/node_modules/dedupped/node_modules/dedupped-child/'), path.join(fixturesPath, '/node_modules/foo/')];
