    ...
    function e() {
      !function(e) {
        ...
        function t(e, t) {
          ...
          return F ? i.stack = null : i.stack = o, i.originalErr = e.originalErr || e, i;
        }
        function r() {}
        function n(t) {
          this._loader = {
        ...
        function f(e, t) {
          ...
          for (var s in o)
            if (!o.hasOwnProperty || o.hasOwnProperty(s)) {
              var l = o[s];
              if (l !== i[s] && (l = o[s] = i[s] = c(o[s], u(o[s]) ? J : e.baseURL)), -1 === s.indexOf("*")) {
                if (t == s)
                  return o[s];
        ...
        function b(e, t, r, n, a) {
          for (var o in t)
            if (-1 != U.call(["main", "format", "defaultExtension", "basePath"], o))
              e[o] = t[o];
            else if ("map" == o)
              g(e.map = e.map || {}, t.map);
            else if ("meta" == o)
              ...
              !a || -1 != U.call(["browserConfig", "nodeConfig", "devConfig", "productionConfig"], o) || t.hasOwnProperty && !t.hasOwnProperty(o) || w.call(n, '"' + o + '" is not a valid package configuration option in package ' + r);
        }
        function y(e, t, r, n) {
          var a;
          if (e.packages[t]) {
        ...
        function E(e) {
          this._loader.baseURL !== this.baseURL && ("/" != this.baseURL[this.baseURL.length - 1] && (this.baseURL += "/"), this._loader.baseURL = this.baseURL = new X(this.baseURL, Q).href);
        }
        function _(e, t) {
          this.set("@system-env", re = this.newModule({
            browser: F,
        ...
        function j(e, t) {
          ...
          if (!ne) {
            var r = this._nodeRequire("module"),
                n = t.substr(q ? 8 : 7);
            ne = new r(n), ne.paths = r._nodeModulePaths(n);
          }
          return ne.require(e);
        }
        function P(e, t) {
        ...
        function k(e, t, r) {
          re.browser && t.browserConfig && r(t.browserConfig), re.node && t.nodeConfig && r(t.nodeConfig), re.dev && t.devConfig && r(t.devConfig), re.build && t.buildConfig && r(t.buildConfig), re.production && t.productionConfig && r(t.productionConfig);
        }
        function O(e) {
          var t = e.match(ie);
        ...
        function z(e) {
          var t,
              ...
              n = "~" == e[0],
              a = e.lastIndexOf("|");
          return -1 != a ? (t = e.substr(a + 1), r = e.substr(n, a - n), n && w.call(this, 'Condition negation form "' + e + '" is deprecated for "' + r + "|~" + t + '"'), "~" == t[0] && (n = !0, t = t.substr(1))) : (t = "default", r = e.substr(n), -1 != le.indexOf(r) && (t = r, r = null)), {
            module: r || "@system-env",
            prop: t,
            negate: n
          };
        ...
        function C(e, t) {
          ...
          return this.builder ? this.normalize(n.module, t).then(function(t) {
            return n.module = t, e.replace(ue, "#{" + I(n) + "}");
        ...
        if (J)
          ...
          J = "file://" + (q ? "/" : "") + process.cwd() + "/", q && (J = J.replace(/\\/g, "/"));
        }
        try {
          var B = "test:" == new e.URL("test:///").protocol;
        } catch (H) {}
        var X = B ? e.URL : e.URLPolyfill;
        D(r.prototype, "toString", {value: function() {
            return "Module";
          }}), function() {
          function e(e) {
            return {
          ...
          function s(e, t, r) {
            l(e, t, r.then(function(r) {
              return "loading" == t.status ? (t.address = r, e.loaderObj.fetch({
                name: t.name,
                metadata: t.metadata,
                address: r
              })) : void 0;
          ...
          function p(e, r, n) {
            ...
            for (var u = e.loads.concat([]),
                ...
                d = u.length; d > o; o++) {
              var r = u[o];
              a.loaderObj.failed = a.loaderObj.failed || [], -1 == U.call(a.loaderObj.failed, r) && a.loaderObj.failed.push(r);
          ...
          function h(e, t) {
            ...
            for (var a = 0,
              ...
              n = U.call(t.linkSets[a].loads, t), -1 != n && t.linkSets[a].loads.splice(n, 1);
        ...
        if ("undefined" != typeof XMLHttpRequest)
          ...
          Z = function(e, t, r, n) {
            ...
            return W = W || require('fs'), e = q ? e.replace(/\//g, "\\").substr(8) : e.substr(7), W.readFile(e, function(e, t) {
              if (e)
                return n(e);
              var a = t + "";
        ...
        !function() {
          ...
          function s(e) {
            ...
            }, a(this, e), e.metadata.integrity && r.setAttribute("integrity", e.metadata.integrity), e.metadata.nonce && r.setAttribute("nonce", e.metadata.nonce), b.appendChild(r), b.removeChild(r), o(), window.onerror = s, i)
              throw i;
          }
          ...
          te = function(e) {
            if (e.source) {
              ...
              try {
                a(this, e), d = e, this._nodeRequire && !h ? (m = m || this._nodeRequire("vm"), m.runInThisContext(n(e, !0), {filename: e.address + (e.metadata.sourceMap ? "!transpiled" : "")})) : (0, eval)(n(e, !0)), o();
              } catch (r) {
        ...
        s(function(e) {
          return function() {
            e.call(this), this.baseURL = J, this.map = {}, this.warnings = !1, this.defaultJSExtensions = !1, this.pluginFirst = !1, this.loaderErrorStack = !1, this.set("@empty", this.newModule({})), _.call(this, !1, !1);
          };
        ...
        i("locate", function(e) {
          ...
          var t = {},
              r = this;
          for (var n in r)
            r.hasOwnProperty && !r.hasOwnProperty(n) || n in a.prototype && "transpiler" != n || -1 == U.call(["_loader", "amdDefine", "amdRequire", "defined", "failed", "version"], n) && (t[n] = r[n]);
          return t.production = re.production, t;
        };
        var oe;
        a.prototype.config = function(e, t) {
          ...
          var n = this;
          if ("loaderErrorStack" in e && (oe = $__curScript, e.loaderErrorStack ? $__curScript = void 0 : $__curScript = oe), "warnings" in e && (n.warnings = e.warnings), e.transpilerRuntime === !1 && (n._loader.loadedTranspilerRuntime = !0), ("production" in e || "build" in e) && _.call(n, !!e.production, !!(e.build || re && re.build)), !t) {
            var a;
            if (k(n, e, function(e) {
              a = a || e.baseURL;
            }), a = a || e.baseURL) {
            ...
            if (e.paths && g(n.paths, e.paths), k(n, e, function(e) {
              e.paths && g(n.paths, e.paths);
            }), this.warnings)
              for (var o in n.paths)
                -1 != o.indexOf("*") && w.call(n, 'Paths configuration "' + o + '" -> "' + n.paths[o] + '" uses wildcards which are being deprecated for simpler trailing "/" folder paths.');
          }
          ...
          for (var j in e) {
            var s = e[j];
            if (-1 == U.call(["baseURL", "map", "packages", "bundles", "paths", "warnings", "packageConfigPaths", "loaderErrorStack", "browserConfig", "nodeConfig", "devConfig", "buildConfig", "productionConfig"], j))
              if ("object" != typeof s || s instanceof Array)
                ...
                for (var o in s)
                  if ("meta" == j && "*" == o[0])
                    ...
                    var O = P.call(n, o);
                    n.defaultJSExtensions && ".js" != O.substr(O.length - 3, 3) && !d(O) && (O += ".js"), g(n[j][O] = n[j][O] || {}, s[o]);
                  } else if ("depCache" == j) {
                    var l = n.defaultJSExtensions && ".js" != o.substr(o.length - 3, 3),
                        u = n.decanonicalize(o);
          ...
          function p(e, t, r) {
            ...
            for (var a in e) {
              var o = "./" == a.substr(0, 2) ? "./" : "";
              if (o && (a = a.substr(2)), n = a.indexOf("*"), -1 !== n && a.substr(0, n) == t.substr(0, n) && a.substr(n + 1) == t.substr(t.length - a.length + n + 1) && r(a, e[o + a], a.split("/").length))
                return;
            }
        ...
        !function() {
          function t(e, r, n) {
            if (n[e.groupIndex] = n[e.groupIndex] || [], -1 == U.call(n[e.groupIndex], e)) {
          ...
          function u(t, r) {
            if (!t.module) {
              ...
              for (var s = 0,
                  d = t.normalizedDeps.length; d > s; s++) {
                var c,
          ...
          function c(t, n) {
            if (!t.module) {
              ...
              var f = t.execute.call(e, function(e) {
                ...
                if (-1 != U.call(t.normalizedDeps, o))
                  return d(o, n);
                throw new Error("Module " + e + " not declared as a dependency of " + t.name);
              }, a, o);
              f && (o.exports = f), a = o.exports, a && (a.__esModule || a instanceof r) ? t.esModule = n.newModule(a) : t.esmExports && a !== e ? t.esModule = n.newModule(p(a)) : t.esModule = n.newModule({"default": a});
            }
          }
          function f(t, r, n, a) {
            if (r && !r.evaluated && r.declarative) {
              n.push(t);
              for (var o = 0,
                  i = r.normalizedDeps.length; i > o; o++) {
                var s = r.normalizedDeps[o];
                -1 == U.call(n, s) && (a.defined[s] ? f(s, a.defined[s], n, a) : a.get(s));
              }
          ...
          a.prototype.register = function(e, t, r) {
            ...
            return function(t) {
              ...
              if (a.defined[t.name])
                ...
                if ("undefined" != typeof te && te.call(a, t), !t.metadata.entry && !t.metadata.bundle)
          ...
          i("translate", function(a) {
            return function(o) {
              var i = this,
                  s = arguments;
              return a.apply(i, s).then(function(a) {
                if ("esm" == o.metadata.format || "es6" == o.metadata.format || !o.metadata.format && a.match(t)) {
                  if ("es6" == o.metadata.format && w.call(i, "Module " + o.name + ' has metadata setting its format to "es6", which is deprecated.\nThis should be updated to "esm".'), o.metadata.format = "esm", o.metadata.deps) {
                    for (var l = "",
                        u = 0; u < o.metadata.deps.length; u++)
                      l += 'import "' + o.metadata.deps[u] + '"; ';
                    o.source = l + a;
                  }
                  if (i.transpiler === !1) {
                    if (i.builder)
                  ...
                  return i._loader.loadedTranspiler = i._loader.loadedTranspiler || !1, i.pluginLoader && (i.pluginLoader._loader.loadedTranspiler = i._loader.loadedTranspiler || !1), (i._loader.transpilerPromise || (i._loader.transpilerPromise = Promise.resolve(e["typescript" == i.transpiler ? "ts" : i.transpiler] || (i.pluginLoader || i)["import"](i.transpiler)))).then(function(e) {
                    return i._loader.loadedTranspilerRuntime = !0, e.translate ? e == o.metadata.loaderModule ? o.source : ("string" == typeof o.metadata.sourceMap && (o.metadata.sourceMap = JSON.parse(o.metadata.sourceMap)), Promise.resolve(e.translate.apply(i, s)).then(function(e) {
                      var t = o.metadata.sourceMap;
                      if (t && "object" == typeof t) {
                        var r = o.address.split("!")[0];
                        t.file && t.file != o.address || (t.file = r + "!transpiled"), (!t.sources || t.sources.length <= 1 && (!t.sources[0] || t.sources[0] == o.address)) && (t.sources = [r]);
                      }
                      return "esm" == o.metadata.format && !i.builder && O(e) && (o.metadata.format = "register"), e;
                    })) : (i.builder && (o.metadata.originalSource = o.source), V.call(i, o).then(function(e) {
        ...
        var se = "undefined" != typeof self ? "self" : "global";
        i("fetch", function(e) {
          return function(t) {
            ...
            return function(o) {
              ...
              if (o.metadata.format || (r.lastIndex = 0, n.lastIndex = 0, (n.exec(o.source) || r.exec(o.source)) && (o.metadata.format = "cjs")), "cjs" == o.metadata.format) {
                ...
                o.metadata.entry = c, c.deps = u, c.executingRequire = !0, c.execute = function(t, r, n) {
                  ...
                  var p = e.define;
                  e.define = void 0, e.__cjsWrapper = c, o.source = f + ") {" + o.source.replace(s, "") + "\n}).apply(__cjsWrapper.exports, __cjsWrapper.args);", te.call(i, o), e.__cjsWrapper = void 0, e.define = p;
                };
              }
              return a.call(i, o);
            };
          ...
          return function() {
            ...
            function a(t, a, i) {
              ...
              var l,
                  u,
                  d;
              -1 != (l = U.call(a, "require")) && (a.splice(l, 1), t || (a = a.concat(r(i.toString(), l)))), -1 != (u = U.call(a, "exports")) && a.splice(u, 1), -1 != (d = U.call(a, "module")) && a.splice(d, 1);
              var c = M();
          ...
          function e(e, t) {
            if (t) {
              var r;
              if (e.pluginFirst) {
                if (-1 != (r = t.lastIndexOf("!")))
                  return t.substr(r + 1);
              } else if (-1 != (r = t.indexOf("!")))
                return t.substr(0, r);
              return t;
            }
          }
          function t(e, t) {
            var r,
                n,
                a = t.lastIndexOf("!");
            return -1 != a ? (e.pluginFirst ? (r = t.substr(a + 1), n = t.substr(0, a)) : (r = t.substr(0, a), n = t.substr(a + 1) || r.substr(r.lastIndexOf(".") + 1)), {
              argument: r,
              plugin: n
            }) : void 0;
          }
          ...
          i("decanonicalize", a), i("normalizeSync", a), i("normalize", function(a) {
            ...
            return function(t) {
              var r,
                  n = this,
                  a = t.name;
              return n.pluginFirst ? -1 != (r = a.indexOf("!")) && (t.metadata.loader = a.substr(0, r), t.name = a.substr(r + 1)) : -1 != (r = a.lastIndexOf("!")) && (t.metadata.loader = a.substr(r + 1), t.name = a.substr(0, r)), e.call(n, t).then(function(e) {
        ...
        }(), G = new a, e.SystemJS = G, G.version = "0.19.35 Standard", "object" == typeof module && module.exports && "object" == typeof exports && (module.exports = G), e.System = G;
