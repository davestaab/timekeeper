...
(function(process) {
  !function(e) {
    function t(e, n) {
      ...
      "file:" == a && (u = u.replace(/\\/g, "/")), this.origin = s ? a + ("" !== a || "" !== s ? "//" : "") + s : "", this.href = a + (a && s || "file:" == a ? "//" : "") + ("" !== o ? o + ("" !== i ? ":" + i : "") + "@" : "") + s + u + c + f, this.protocol = a, this.username = o, this.password = i, this.host = s, this.hostname = d, this.port = l, this.pathname = u, this.search = c, this.hash = f;
    }
    e.URLPolyfill = t;
    ...
    function t(e, t) {
      ...
      return y ? i.stack = null : i.stack = o, i.originalErr = e.originalErr || e, i;
    }
    function n() {}
    function r(t) {
      this._loader = {
    ...
    function a() {
      r.call(this), this.paths = {}, this._loader.paths = {}, M.call(this);
    }
    function o() {}
    function i(e, t) {
    ...
    function l(e, t) {
      ...
      return new j(e, t && t.replace(/#/g, "%05") || R).href.replace(/%05/g, "#");
    }
    function u(e, t) {
      var n,
          r = "",
      ...
      for (var s in o)
        if (!o.hasOwnProperty || o.hasOwnProperty(s)) {
          var u = o[s];
          if (u !== i[s] && (u = o[s] = i[s] = l(o[s], d(o[s]) ? S : e.baseURL)), -1 === s.indexOf("*")) {
            if (t == s)
              return o[s];
    ...
    w(n.prototype, "toString", {value: function() {
      ...
      function p(e, n, r) {
        ...
        for (var l = e.loads.concat([]),
            ...
            u = l.length; u > o; o++) {
          var n = l[o];
          a.loaderObj.failed = a.loaderObj.failed || [], -1 == x.call(a.loaderObj.failed, n) && a.loaderObj.failed.push(n);
      ...
      function h(e, t) {
        ...
        for (var a = 0,
          ...
          r = x.call(t.linkSets[a].loads, t), -1 != r && t.linkSets[a].loads.splice(r, 1);
    ...
    a.prototype.normalize = function(e, t, n) {
      return e = e.match(I) || "." == e[0] ? new j(e, t || S).href : new j(u(this, e) || e, S).href;
    }, function() {
      function t() {
      ...
      i("pushRegister_", function(e) {
        return function(n) {
          return e.call(this, n) ? !1 : (d ? this.reduceRegister_(d, n) : l ? this.reduceRegister_(t(), n) : c ? f.push(n) : this.reduceRegister_(null, n), !0);
        };
      }), i("fetch", function(t) {
        return function(i) {
          var d = this;
    ...
    !function() {
      function t(e, n, r) {
        if (r[e.groupIndex] = r[e.groupIndex] || [], -1 == x.call(r[e.groupIndex], e)) {
      ...
      function l(t, n) {
        if (!t.module) {
          ...
          for (var s = 0,
              u = t.normalizedDeps.length; u > s; s++) {
            var c,
      ...
      function m(t, r) {
        if (!t.module) {
          ...
          var c = t.execute.call(e, function(e) {
            ...
            if (-1 != x.call(t.normalizedDeps, o))
              return u(o, r);
            throw new Error("Module " + e + " not declared as a dependency of " + t.name);
          }, a, o);
          c && (o.exports = c), a = o.exports, a && (a.__esModule || a instanceof n) ? t.esModule = r.newModule(a) : t.esmExports && a !== e ? t.esModule = r.newModule(f(a)) : t.esModule = r.newModule({"default": a});
        }
      }
      function p(t, n, r, a) {
        if (n && !n.evaluated && n.declarative) {
          ...
          for (var o = 0,
            ...
            -1 == x.call(r, s) && (a.defined[s] ? p(s, a.defined[s], r, a) : a.get(s));
          }
    ...
    }), k = new a, e.SystemJS = k, k.version = "0.19.35 Register Only", "object" == typeof module && module.exports && "object" == typeof exports && (module.exports = k), e.System = k;
