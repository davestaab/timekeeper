    ...
    function e() {
      !function(e) {
        ...
        function t(e, t) {
          ...
          return q ? i.stack = null : i.stack = o, i.originalErr = e.originalErr || e, i;
        }
        function n() {}
        function r(t) {
          this._loader = {
        ...
        function c(e, t) {
          if ("." == e[0]) {
            if ("/" == e[1] && "." != e[2])
              return (t && t.substr(0, t.lastIndexOf("/") + 1) || N) + e.substr(2);
          } else if ("/" != e[0] && -1 == e.indexOf(":"))
            return (t && t.substr(0, t.lastIndexOf("/") + 1) || N) + e;
        ...
        function y(e, t, n, r, a) {
          for (var o in t)
            if (-1 != J.call(["main", "format", "defaultExtension", "basePath"], o))
              e[o] = t[o];
            else if ("map" == o)
              g(e.map = e.map || {}, t.map);
            else if ("meta" == o)
              ...
              !a || -1 != J.call(["browserConfig", "nodeConfig", "devConfig", "productionConfig"], o) || t.hasOwnProperty && !t.hasOwnProperty(o) || w.call(r, '"' + o + '" is not a valid package configuration option in package ' + n);
        }
        function b(e, t, n, r) {
          var a;
          if (e.packages[t]) {
        ...
        function _(e, t) {
          ...
          if ("@node/" == e.substr(0, 6)) {
            ...
            return this.set(e, this.newModule(p(k.call(this, e.substr(6), this.baseURL)))), e;
          }
        ...
        function z(e) {
          var t,
              ...
              r = "~" == e[0],
              a = e.lastIndexOf("|");
          return -1 != a ? (t = e.substr(a + 1), n = e.substr(r, a - r), r && w.call(this, 'Condition negation form "' + e + '" is deprecated for "' + n + "|~" + t + '"'), "~" == t[0] && (r = !0, t = t.substr(1))) : (t = "default", n = e.substr(r), -1 != oe.indexOf(n) && (t = n, n = null)), {
            module: n || "@system-env",
            prop: t,
            negate: r
          };
        ...
        if ("undefined" != typeof document && document.getElementsByTagName) {
          ...
          "undefined" != typeof location && (N = e.location.href);
        if (N)
          N = N.split("#")[0].split("?")[0], N = N.substr(0, N.lastIndexOf("/") + 1);
        else {
        ...
        if ("undefined" != typeof XMLHttpRequest)
          ...
          Q = function(e, t, n, r) {
            ...
            return W = W || require('fs'), e = U ? e.replace(/\//g, "\\").substr(8) : e.substr(7), W.readFile(e, function(e, t) {
              if (e)
                return r(e);
              var a = t + "";
        ...
        i("locate", function(e) {
          ...
          var t = {},
              n = this;
          for (var r in n)
            n.hasOwnProperty && !n.hasOwnProperty(r) || r in a.prototype && "transpiler" != r || -1 == J.call(["_loader", "amdDefine", "amdRequire", "defined", "failed", "version"], r) && (t[r] = n[r]);
        ...
        a.prototype.config = function(e, t) {
          ...
          var r = this;
          if ("loaderErrorStack" in e && (re = $__curScript, e.loaderErrorStack ? $__curScript = void 0 : $__curScript = re), "warnings" in e && (r.warnings = e.warnings), e.transpilerRuntime === !1 && (r._loader.loadedTranspilerRuntime = !0), ("production" in e || "build" in e) && P.call(r, !!e.production, !!(e.build || ee && ee.build)), !t) {
            var a;
            if (j(r, e, function(e) {
              a = a || e.baseURL;
            }), a = a || e.baseURL) {
            ...
            if (e.paths && g(r.paths, e.paths), j(r, e, function(e) {
              ...
              for (var o in r.paths)
                -1 != o.indexOf("*") && w.call(r, 'Paths configuration "' + o + '" -> "' + r.paths[o] + '" uses wildcards which are being deprecated for simpler trailing "/" folder paths.');
          }
          ...
          for (var k in e) {
            var s = e[k];
            if (-1 == J.call(["baseURL", "map", "packages", "bundles", "paths", "warnings", "packageConfigPaths", "loaderErrorStack", "browserConfig", "nodeConfig", "devConfig", "buildConfig", "productionConfig"], k))
              if ("object" != typeof s || s instanceof Array)
                ...
                for (var o in s)
                  if ("meta" == k && "*" == o[0])
                    ...
                    var O = _.call(r, o);
                    r.defaultJSExtensions && ".js" != O.substr(O.length - 3, 3) && !d(O) && (O += ".js"), g(r[k][O] = r[k][O] || {}, s[o]);
                  } else if ("depCache" == k) {
                    var l = r.defaultJSExtensions && ".js" != o.substr(o.length - 3, 3),
                        u = r.decanonicalize(o);
        ...
        !function() {
          ...
          function c(t, r) {
            if (!t.module) {
              ...
              f && (o.exports = f), a = o.exports, a && (a.__esModule || a instanceof n) ? t.esModule = r.newModule(a) : t.esmExports && a !== e ? t.esModule = r.newModule(p(a)) : t.esModule = r.newModule({"default": a});
            }
          }
          function f(t, n, r, a) {
            if (n && !n.evaluated && n.declarative) {
              r.push(t);
              for (var o = 0,
                  i = n.normalizedDeps.length; i > o; o++) {
        ...
        }), G = new a, e.SystemJS = G, G.version = "0.19.35 CSP", "object" == typeof module && module.exports && "object" == typeof exports && (module.exports = G), e.System = G;
      }("undefined" != typeof self ? self : global);
    }
    var t = "undefined" == typeof Promise;
    if ("undefined" != typeof document) {
      var n = document.getElementsByTagName("script");
      if ($__curScript = n[n.length - 1], ($__curScript.defer || $__curScript.async) && ($__curScript = document.currentScript), t) {
