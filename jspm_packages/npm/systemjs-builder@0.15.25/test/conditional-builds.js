...
suite('Conditional Builds', function() {
  ...
  test('traceConditionModules false', function() {
    return builder.trace('pkg/env-condition + interpolated-#{conditions.js|test}.js', {traceConditionModules: false}).then(function(tree) {
  ...
  test('Bundle conditional inlining', function() {
    return builder.bundle('interpolated-#{conditions.js|test}.js', {
      ...
      conditions: {'conditions.js|test': '2'}
