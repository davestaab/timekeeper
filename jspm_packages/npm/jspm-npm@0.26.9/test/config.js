...
(function(process) {
  ...
  System.config({"map": {
      ...
      "github:jspm/nodelibs-buffer@0.1.0": {"buffer": "npm:buffer@3.2.2"},
      "github:jspm/nodelibs-console@0.1.0": {"console-browserify": "npm:console-browserify@1.1.0"},
      "github:jspm/nodelibs-constants@0.1.0": {"constants-browserify": "npm:constants-browserify@0.0.1"},
      "github:jspm/nodelibs-crypto@0.1.0": {"crypto-browserify": "npm:crypto-browserify@3.9.14"},
      "github:jspm/nodelibs-domain@0.1.0": {"domain-browser": "npm:domain-browser@1.1.4"},
      ...
      "github:jspm/nodelibs-punycode@0.1.0": {"punycode": "npm:punycode@1.3.2"},
      ...
      "github:jspm/nodelibs-timers@0.1.0": {"timers-browserify": "npm:timers-browserify@1.4.1"},
      ...
      "npm:domain-browser@1.1.4": {"events": "github:jspm/nodelibs-events@0.1.1"},
      "npm:elliptic@3.1.0": {
        "bn.js": "npm:bn.js@2.0.5",
      ...
      "npm:process@0.11.1": {"assert": "github:jspm/nodelibs-assert@0.1.0"},
      ...
      "npm:timers-browserify@1.4.1": {"process": "npm:process@0.11.1"},
      "npm:url@0.10.3": {
        "assert": "github:jspm/nodelibs-assert@0.1.0",
