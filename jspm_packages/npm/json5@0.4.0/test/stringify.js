...
var simpleCases = [null, 9, -9, +9, +9.878, '', "''", '999', '9aa', 'aaa', 'aa a', 'aa\na', 'aa\\a', '\'', '\\\'', '\\"', undefined, true, false, {}, [], function() {}, Date.now(), new Date(Date.now())];
exports.stringify = {};
...
exports.stringify.arrays = function test() {
  ...
  assertStringify([1, 'fasds', ['fdsafsd'], null, function(aaa) {
    return 1;
  }, false]);
  assertStringify([1, 'fasds', ['fdsafsd'], undefined, function(aaa) {
    return 1;
  }, false]);
};
exports.stringify.objects = function test() {
  ...
  assertStringify({
    "a$222222_aa": [1, {}, undefined, function() {}, {jjj: function() {}}],
    'bbbb': {
      aaaa: 2,
      name: 'other',
      foo: undefined
  ...
  assertStringify({
    a: innerObj,
    b: innerObj,
    c: [innerObj, innerObj, innerObj]
  });
};
exports.stringify.oddKeys = function test() {
  assertStringify({
    "this is a crazy long key": 1,
    'bbbb': 2
  });
  assertStringify({
    "": 1,
...
exports.stringify.replacer.function.complexObject = function test() {
  ...
  var expectedKeys = ['', '', 'one', 'two', 'three', 0, 1, 'four', 'nested_one', 'five', 'six', 'seven', 'eight', 'nine', 'ten', 0, 1, 2, 'eleven'];
  var expectedHolders = [{"": obj}, obj, obj, obj, obj, obj.three, obj.three, obj, obj.four, obj, obj, obj, obj, obj, obj, obj.ten, obj.ten, obj.ten, obj];
...
exports.stringify.replacer.array.complexObject = function test() {
  var obj = {
    ...
    four: {
      nested_one: 'anotherString',
      nested_one_remove: 'anotherString'
    },
    four_remove: {
      nested_one: 'anotherString',
      nested_one_remove: 'anotherString'
  ...
  var ReplacerTest = function() {
    return {
      replacer: ['one', 'two', 'three', 'four', 'nested_one', 'five', 'six', 'seven', 'eight', 'nine', 'ten', 'eleven', 0],
      assert: function() {}
    };
  };
  assertStringify(obj, ReplacerTest);
...
exports.stringify.toJSON = function test() {
  ...
  var object = {customToJSONObject: customToJSONObject};
  assertStringify(object);
  var nested = {
    name: 'nested',
    toJSON: function() {
...
function stringifyJSON(obj, replacer, space) {
  ...
  try {
    ...
    function findKeys(key, innerObj) {
      ...
      if (JSON5.isWord(key) && typeof innerObj !== 'function' && typeof innerObj !== 'undefined') {
        keys.push(key);
      }
...
function assertStringify(obj, replacerTestConstructor, expectError) {
  ...
  var indents = [undefined, " ", "          ", "                    ", "\t", "this is an odd indent", 5, 20, '\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t'];
