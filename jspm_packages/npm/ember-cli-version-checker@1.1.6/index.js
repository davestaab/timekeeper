...
Object.defineProperty(DependencyVersionChecker.prototype, 'version', {get: function() {
...
VersionChecker.assertAbove = function deprecatedAssertAbove(addon, comparisonVersion, _message) {
  ...
  var message = _message;
  if (!message) {
    message = 'The addon `' + addon.name + '` requires an Ember CLI version of ' + comparisonVersion + ' or above, but you are running ' + dependencyChecker.version + '.';
  }
