...
(function(Buffer, process) {
 ...
 while (quad = quad.next);
    ...
    function area$2(object) {
      if (areaSum)
        ...
        areaSum = adder(), areaRingSum = adder();
 ...
 while ((a = (a + direction + 4) % 4) !== a1);
    ...
    function transform$1(prototype) {
      return {stream: transform$2(prototype)};
    }
    ...
    function resampleNone(project) {
      return transform$2({point: function(x, y) {
          x = project(x, y);
    ...
    var transformRadians = transform$2({point: function(x, y) {
